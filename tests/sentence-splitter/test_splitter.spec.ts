...
const test_ko_paragraph =
  "맨까 새끼들 부들부들하구나. 억까를 해 봐도 우린 골 넣지! 니네가 아무리 맹구다 어쩐다고 놀려도 아아~ 즐겁구나 오 늘 이~ 짜스! 맨까 새끼들 부들부들하구나! 살짝쿵 설렜니. 아니 안 되지! 이겨도 지랄 져도 지랄 뭐만 하면 리그컵. 아~ 리그컵도 축 군 데~ 컴온!! 맨까 새끼들 부들부들하구나~ 돌아온 미친 폼 누가 막을래? 더 보기 리그 탈출 직전 돌아와요! 맨유 팬! 아~ 기대된다 챔 스 가~ Siuuuuuuu!";
