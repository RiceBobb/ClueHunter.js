...
const en_sample_passage_list = [
  { pageContent: "Truman opened his front door and stepped outside.", metadata: {} },
  { pageContent: "The morning sun greeted him, but something felt different.", metadata: {} },
  { pageContent: "He looked up and noticed a stage light had fallen from the sky, shattering on the pavement.", metadata: {} },
  { pageContent: "Picking it up, he read the label: 'Sirius (9 Canis Major)'.", metadata: {} },
  { pageContent: "His heart raced. A star falling from the sky? Impossible.", metadata: {} },
  { pageContent: "Truman glanced around, searching for someone—anyone—who could explain this.", metadata: {} },
  { pageContent: "But the street was unusually empty.", metadata: {} },
  { pageContent: "Driving to work later that morning, Truman turned on the radio.", metadata: {} },
  { pageContent: "Static filled the car before a voice crackled through.", metadata: {} },
  { pageContent: "'He's turning onto Main Street now. Keep the bus in position.'", metadata: {} },
  { pageContent: "Truman's hands froze on the wheel.", metadata: {} },
  { pageContent: "The voice was talking about him.", metadata: {} },
  { pageContent: "Panic rising, he spun the dial, but every channel was the same—monitoring his movements.", metadata: {} },
  { pageContent: "That evening, Truman sat on the beach, staring at the horizon.", metadata: {} },
  { pageContent: "He remembered Sylvia, the woman who had tried to warn him.", metadata: {} },
  { pageContent: "'They’re watching you, Truman!' she had shouted before being dragged away.", metadata: {} },
...
function validation_results(results: any[], test_passage_list: any[]) {
  ...
  expect(results[0].metadata.bm25Score).to.be.greaterThanOrEqual(results[1].metadata.bm25Score); 
}
